...
## from median Northern Groundwater concentration
ewat <- c("SOLUTION 1",
          "units mol/kgw",
          "temp 25",
          "pressure 1",
...
init <- c(Al=1.638e-07, C=1.779e-03, Ca=1.074e-04, Cl=2.384e-04, Fe=3.436e-06,
          K=1.812e-05, Mg=2.647e-04, Na=5.178e-04, S=1.180e-05, Si=3.986e-04,
          pH=6.463)
...
#               "Chlorite(14A)", "Calcite")
#New Phases tested from the original rainwater / central zone inverse
#Running
primary <- c("Plagioclase","Albite", "Anorthite", "K-mica", "K-feldspar", "Quartz", 
>>>>>>> f4e2707376d3d4c692cc84827e58cc99eff00779
             "Chalcedony", "Pyrite")
secondary <- c("Kaolinite", 
               "Chlorite(14A)", "Calcite")
#New Phases tested from the original rainwater / central zone inverse
...
#primary <- c("Plagioclase","Albite", "Anorthite", "K-mica", "K-feldspar", "Quartz", 
#             "Chalcedony", "Pyrite")
#secondary <- c("Kaolinite", "Illite", "Chlorite(14A)", "Fe(OH)3(a)", "Goethite", "Calcite")
