...
## from median "Evaporated_Rainwater_Conc.txt" Rainwater to northern zone: 47.6% evaporation
ewat <- c("SOLUTION 1",
          "units mol/kgw",
          "temp 25",
          "pressure 1",
...
init <- c(Al=NA, C=3.186e-04, Ca=4.176e-04, Cl=3.674e-04, Fe=NA,
          K=4.331e-05, Mg=3.002e-05, Na=4.699e-05, S=3.376e-04, Si=NA,
          pH=4.258)
