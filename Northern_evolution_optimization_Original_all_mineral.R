...
## from median "Evaporated_Rainwater_Conc.txt"
ewat <- c("SOLUTION 1",
          "units mol/kgw",
          "temp 25",
          "pressure 1",
         ...
         "PURE 1",
         "END")
## from median solution> here the rainwater has been equilibrated with CO2 and reacted with 0.0017 moles of Formalin
#ewat <- c("SOLUTION 1",
#          "units mol/kgw",
#          "temp 25",
#         "pressure 1",
...
## Evaporated rainwater concentration with matched Cl concentration with Solution A (BH Asiakwa SOS) from Northern zone
#ewat <- c("SOLUTION 1",
#          "units mol/kgw",
#          "temp 25",
#         "pressure 1",
...
## Evaporated rainwater concentration with matched Cl concentration with Solution B (Osino Danso BH) from Northern zone
#ewat <- c("SOLUTION 1",
#          "units mol/kgw",
#          "temp 25",
#          "pressure 1",
...
#          "PURE 1",
#          "END")
## Evaporated rainwater concentration with matched Cl concentration with Solution C (Jejeti BH) from Northern zone
...
## Evaporated rainwater concentration with matched Cl concentration with Solution D (Asuboni BH) from Northern zone
#ewat <- c("SOLUTION 1",
#          "units mol/kgw",
#          "temp 25",
#          "pressure 1",
...
## Evaporated rainwater concentration with matched Cl concentration with Solution E (Kofi Dede BH) from Northern zone
#ewat <- c("SOLUTION 1",
#          "units mol/kgw",
#          "temp 25",
#          "pressure 1",
...
## Evaporated rainwater concentration with matched Cl concentration with Solution F (Kwahu Oda) from Northern zone
#ewat <- c("SOLUTION 1",
#          "units mol/kgw",
#          "temp 25",
#          "pressure 1",
...
## Evaporated rainwater concentration with matched Cl concentration with Solution G (Okyinso) from Northern zone
#ewat <- c("SOLUTION 1",
#          "units mol/kgw",
#          "temp 25",
#          "pressure 1",
...
## Evaporated rainwater concentration with matched Cl concentration with Solution H (Awaham) from Northern zone
#ewat <- c("SOLUTION 1",
#          "units mol/kgw",
#          "temp 25",
#          "pressure 1",
...
## Individual groundwater soultions which the median conc was taken from solution (A - H)

## Solution A
#init <- c(C=1.013e-03, Ca=1.328e-03, Cl=1.167e-03,
#          K=1.377e-04, Mg=9.548e-05, Na=1.494e-04, S=1.074e-03, Si=NA,
#          pH=3.798)

## Initial solution from Solution B
#init <- c(C= 5.218e-04, Ca=6.839e-04, Cl= 6.008e-04, Fe=NA,
#         K= 7.092e-05, Mg=4.916e-05, Na=7.695e-05, S=5.529e-04, Si=NA,
#         pH=4.061)

## Initial solution from Solution C
#init <- c(C=1.103e-03, Ca=1.446e-03, Cl=1.270e-03, Fe=NA,
#          K=1.500e-04, Mg=1.040e-04, Na=1.627e-04, S=1.169e-03, Si=NA,
#          pH=3.764)

## Initial solution from Solution D
#init <- c(C=1.447e-03, Ca=1.896e-03, Cl=1.666e-03,
#          K= 1.966e-04, Mg=1.363e-04, Na=2.133e-04, S=1.533e-03, Si=NA,
#         pH=3.658)

## Initial solution from Solution E
#init <- c(C=1.433e-03, Ca=1.878e-03, Cl=1.650e-03,
#          K=1.948e-04, Mg= 1.350e-04, Na=2.113e-04, S=1.518e-03, Si=NA,
#          pH=3.662)

## Initial solution from Solution F
#init <- c(C=1.139e-03, Ca=1.493e-03, Cl=1.312e-03,
#          K=1.548e-04, Mg= 1.073e-04, Na= 1.680e-04, S=1.207e-03, Si=NA,
#          pH=3.752)

## Initial solution from Solution G
#init <- c(C= 8.433e-04, Ca=1.105e-03, Cl=9.709e-04, Fe=NA,
#          K=1.146e-04, Mg=7.946e-05, Na=1.244e-04, S= 8.935e-04, Si=NA,
#         pH=3.870)

## Initial solution from Solution H
#init <- c(Al=NA, C=3.172e-03, Ca=4.157e-03, Cl= 3.652e-03, Fe=NA,
#          K=4.311e-04, Mg=2.989e-04, Na=4.678e-04, S=3.361e-03, Si=NA,
#          pH=3.359)

## Final simulated best matched concentration
#init <- c(Al=2.344e-07, C=1.147e-03, Ca=1.504e-03, Cl=1.321e-03, Fe=1.885e-09,
#          K=1.782e-07, Mg=4.199e-04, Na=1.180e-03, S=1.216e-03, Si=1.710e-03,
#          pH=8.4990)
...
## modified phases (original working minerals)
primary <- c("Albite", "Anorthite", "Phlogopite", "K-mica", "K-feldspar", "Quartz", 
             "Chalcedony", "Pyrite", "Siderite")
secondary <- c("Kaolinite", "Ca-Montmorillonite", "Goethite", "Aragonite", "Fe(OH)3(a)", "Calcite", "Chlorite(14A)")

#prototype( model)
#primary <- c("Albite", "Anorthite","Plagioclase", "Phlogopite", "K-mica", "K-feldspar", "Quartz", 
#             "Chalcedony", "Pyrite", "Aragonite", "Calcite", "Siderite")
#secondary <- c("Kaolinite", "Ca-Montmorillonite", "Goethite", "Fe(OH)3(a)", "Hematite", "Chlorite(14A)")

#primary <- c("Albite", "Plagioclase", "Anorthite", "Phlogopite", "K-mica", "K-feldspar", "Quartz", 
 #            "Chalcedony", "Pyrite", "Calcite", "Fe(OH)3(a)")
#secondary <- c("Kaolinite", "Ca-Montmorillonite", "Goethite", "Chlorite(14A)")
...
tot <- c(DoCombSim(initsol = ewat, db="phreeqc_invPra.dat", primary = primary, secondary = secondary, len=2, procs=3),
         DoCombSim(initsol = ewat, db="phreeqc_invPra.dat", primary = primary, secondary = secondary, len=3, procs=3))
         #DoCombSim(initsol = ewat, db="phreeqc_invPra.dat", primary = primary, secondary = secondary, len=4, procs=3))
         #DoCombSim(initsol = ewat, db="phreeqc_invPra.dat", primary = primary, secondary = secondary, len=5, procs=4))
...
NewInput
Distribute(NewInput, prop="Pyrite", values=paste(calibpyr$minimum, "2"))
...
## Plotting the calibrated concentrations with initial and target solutions
...
textCa <- filtered[[which.min(restot$Ca)]]$pphases
barplot(textCa$delta, names.arg=row.names(textCa), las=2, ylab="mol/kgw")
legend("topleft", c("Ca"))
...
viz1 <- dat[order(b1),][1:40,]
viz2 <- dat[order(b2),][1:40,]
