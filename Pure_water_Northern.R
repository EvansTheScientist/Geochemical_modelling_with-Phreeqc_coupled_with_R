...
init <- c(Al=NA, C=NA, Ca=NA, Cl=NA, Fe=NA,
          K=NA, Mg=NA, Na=NA, S=NA, Si=NA,
          pH=7.0)
...
secondary <- c("Kaolinite", 
               "Hematite", "Chlorite(14A)", "Fe(OH)3(a)", "Calcite")
##Tobias
#primary <- c("Albite", "Phlogopite", "K-mica", "K-feldspar", 
#             "Pyrite")
#secondary <- c("Kaolinite", "Chlorite(14A)",  "Calcite", "Fe(OH)3(a)")
