...
## from median "Evaporated_Rainwater_Conc.txt" Rainwater to northern zone: 47.6% evporation
ewat <- c("SOLUTION 1",
          "units mol/kgw",
          "temp 25",
          "pressure 1",
...
init <- c(C=6.628e-04, Ca=8.688e-04, Cl=7.643e-04, Fe=NA,
          K=9.010e-05, Mg=6.246e-05, Na=9.775e-05, S=7.023e-04, Si=NA,
          pH=3.966)
...
primary <- c("Albite", "Phlogopite", "K-mica", "K-feldspar", "Quartz", 
             "Chalcedony", "Fe(OH)3(a)", "Chlorite(14A)", "Calcite")
secondary <- c("Kaolinite", "Ca-Montmorillonite")
...
## Find out the best 50 simulations given a certain metric, in this
## case rrmse
inds_best <- order(restot$Na)[1:50]
